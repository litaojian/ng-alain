...
import { ReuseTabCached, ReuseTabNotify, ReuseTabMatchMode } from '@delon/abc';

@Component({
    selector: 'my-reuse-tab',
    templateUrl: './my-reuse-tab.component.html',
    styleUrls: ['./my-reuse-tab.less'],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class MyReuseTabComponent implements OnInit, OnChanges, OnDestroy {
