...
export class FirstComponent {
    ...
    ngOnInit() {
           ...
           this.search.ksfxsj=this.DatePipe.transform(oneweekdate,'y-MM-dd HH:mm:ss');
           this.search.jsfxsj=this.DatePipe.transform(new Date(),'y-MM-dd HH:mm:ss');
 ...
 private getKkou(e){
  ...
  private addMessage(){
        this.searchL= {
                    ksfxsj:this.search.ksfxsj,
                    jsfxsj:this.search.jsfxsj,
                    fxfw: this.search.fxfw,
                    kkmc: this.search.kkmc,
                    hssj: this.search.hssj
                };
...
private recentCarDetail(car){
     ...
     this.frstService.recentCar({"hphm":car.hphm,"hpzl":car.hpzl,"minTime":this.list[0].ksfxsj}).subscribe(data => { 
...
private showFrequentDetail(index,car){
      ...
      this.areaDetail.gckssj=this.list[index].ksfxsj;
      this.areaDetail.gcjssj=this.list[index].jsfxsj;
