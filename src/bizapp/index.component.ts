    ...
    <nz-layout class="layout">
      <nz-header>
        ...
        <ul nz-menu [nzTheme]="'dark'" [nzMode]="'horizontal'" style="line-height: 64px;">
          <li nz-menu-item><a routerLink="/page/admin/role">角色</a></li>
          <li nz-menu-item><a routerLink="/page/admin/user">用户</a></li>
          <li nz-menu-item><a routerLink="/page/admin/menu">菜单</a></li>
        </ul>
      </nz-header>
      <nz-layout>
        ...
        <nz-layout style="padding:0 24px 24px">
          ...
          <nz-content style="background:#fff; padding: 24px; height:100%; min-height: 280px;">Content</nz-content>
        </nz-layout>
      </nz-layout>
    </nz-layout>
  `,
