...
;(function(root, factory) {
    ...
    jedfn.dateClose = function() {
        ...
        /** Add By zhangxin Start **/
        if ($.isFunction(this.opts.closefun) || this.opts.closefun != null) this.opts.closefun();
        /** Add By zhangxin End **/
    };
    //为日期绑定各类事件
    jedfn.eventsDate = function(opts,boxCell) {
        ...
        boxCell.find(".jedatebot .jedateok").on("click", function(ev) {
            ...
            that.dateClose();
            // 点击确定时触发选中事件 ** Add By ZhangXin Start **
            if ($.isFunction(opts.choosefun) || opts.choosefun != null){
                opts.choosefun && opts.choosefun(elemCell,okVal,okdate);
            }
            // ** Add By zhangxin End **
        ...
        $(document).on("mouseup scroll", function(ev) {
            ...
            if (jet.boxelem == "#jedatebox"){
                ...
                /** Add By zhangxin Start **/
                if ($.isFunction(opts.closefun) || opts.closefun != null) opts.closefun();
                /** Add By zhangxin End **/
            }
        });
